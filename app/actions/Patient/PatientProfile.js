            ...
            <View style={{flex: 1}}>
                <View style={Styles.containerStyle}>
                    ...
                    <ScrollView
                        ...
                        <View style={[styles.person, {backgroundColor: '#E0E0E0'}]}>
                            <View style={[styles.personInformation, {height: 250}]}>
                                {(this.state.avatar) ? (
                                    <Image
                            ...
                            <View style={{backgroundColor: '#E0E0E0', marginBottom: 10, marginTop: -10}}>
                            ...
                            <View style={{backgroundColor: '#E0E0E0', marginBottom: 20, marginTop: -10}} collapsable={true}>
                                <View style={[styles.rows, {flexDirection: 'column'}]}>
                            ...
                            <View style={{backgroundColor: '#E0E0E0', marginBottom: 40, marginTop: -10}} collapsable={true}>
                                <View style={[styles.rows, {flexDirection: 'column'}]}>
